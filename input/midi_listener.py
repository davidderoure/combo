"""Real-time MIDI input feeding a SubGestureRecognizer.
...
class MidiListener:
    """Listens on a MIDI input port and drives a SubGestureRecognizer."""

    def __init__(self, recognizer: SubGestureRecognizer):
