...
Chord indices are defined in chords.py. The model takes chord as an
additional input embedding at each timestep but does not predict it as output.

Ported from wolfson's data/encoding.py — see ensemble/wolfson/__init__.py for
what changed mechanically vs. the source.
"""
