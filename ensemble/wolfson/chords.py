...
Ported from wolfson's data/chords.py — see ensemble/wolfson/__init__.py for
what changed mechanically vs. the source. combo's own chord-quality mapping
(song/chord.py's Chord -> this module's chord index) lives in ensemble/sax.py,
not here — parse_chord below (WJD chord-string parsing) is unused by combo,
kept only because it ships with the rest of this file's vocabulary constants.
"""
